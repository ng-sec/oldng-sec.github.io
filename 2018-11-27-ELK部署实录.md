...
ELK Splunk logstash elk 破解 elk crack 
0.前言
1.准备工作
1.1 架构涉及
1.2 服务器环境准备
...
>近年来大数据越来越火，splunk、elk等等大数据工具非常火热。运维人员面临数据越来越多的问题。接触ELK源于公司准备建设SOC，本文主要告诉大家如何搭建elk平台、使用elk介入安全设备的日志以及x-pack的破解

1.准备工作

1.1 架构设计

192.168.80.161 Elasticsearch/Kibana/Logstash
192.168.80.162 Elasticsearch

1.2 服务器环境准备

系统安装
参考链接：
192.168.80.161 安装CentOS7.2
192.168.80.162 安装CentOS7.2
