...
Enter file in which to save the key (/c/Users/robin/.ssh/id_rsa): <font color=red >Enter</font> 
Created directory '/c/Users/robin/.ssh'.  
Enter passphrase (empty for no passphrase):  <font color=red >password</font>
Enter same passphrase again:  <font color=red >password</font>
